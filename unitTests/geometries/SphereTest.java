...
class SphereTest {
    ...
    public void findIntersections() {
        ...
        assertEquals(null,sphere.findIntersectionpoints(new Ray(new Point(-1, 0, 0), new Vector(1, 1, 0))));
        ...
        assertEquals(Arrays.asList(p1, p2), result1);
        ...
        assertEquals(Arrays.asList(p3), result2);
        ...
        assertEquals(Arrays.asList(p4), result4);
        ...
        assertEquals(Arrays.asList(p5, p6), result6);
        ...
        assertEquals(Arrays.asList(p7), result7);
        ...
        assertEquals(Arrays.asList(p8), result8);
        ...
        assertEquals( Arrays.asList(p9), result9);
        ...
        assertEquals( Arrays.asList(p12), result12);
